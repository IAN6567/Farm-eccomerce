...
function setupEventListeners() {
  ...
  // Improve mobile tap targets: allow Enter key to trigger search
  document
    .getElementById("productSearch")
...
async function handleRegister(e) {
  ...
  try {
    ...
    if (response.ok) {
      ...
      showAlert(
        "Registration successful! Welcome to FarmConnect Kenya!",
        "success"
      );
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="farmer-card">
                <div class="farmer-info">
                    <img src="${
                      farmer.profileImage || "/images/avatar-placeholder.jpg"
                    }" 
                         alt="${farmer.firstName} ${farmer.lastName}" 
                         class="farmer-avatar mb-3">
                    <h5 class="farmer-name">${farmer.firstName} ${
        farmer.lastName
      }</h5>
      ...
      (item) => `
        <div class="cart-item">
            ...
            <div class="cart-item-controls">
                ...
                <button class="btn btn-outline-danger btn-sm ms-2" onclick="removeFromCart('${
                  item.productId
                }')">
